...
override PKGDIR = ti/sdo/ce/views
...
package/%.xdc.inc package/%_ti.sdo.ce.views.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.ce.views" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.ce.views $@
...
.PHONY: release,ti_sdo_ce_views
ti_sdo_ce_views.tar: package/package.bld.xml
ti_sdo_ce_views.tar: package/package.ext.xml
ti_sdo_ce_views.tar: package/package.rel.dot
ti_sdo_ce_views.tar: package/build.cfg
ti_sdo_ce_views.tar: package/package.xdc.inc
ti_sdo_ce_views.tar: package.bld
ti_sdo_ce_views.tar: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_ce_views.tar.dep
endif
package/rel/ti_sdo_ce_views/ti/sdo/ce/views/package/package.rel.xml:

ti_sdo_ce_views.tar: package/rel/ti_sdo_ce_views.xdc.inc package/rel/ti_sdo_ce_views/ti/sdo/ce/views/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sdo_ce_views.xdc.inc,package/rel/ti_sdo_ce_views.tar.dep)


release release,ti_sdo_ce_views: all ti_sdo_ce_views.tar
clean:: .clean
	-$(RM) ti_sdo_ce_views.tar
	-$(RM) package/rel/ti_sdo_ce_views.xdc.inc
	-$(RM) package/rel/ti_sdo_ce_views.tar.dep
