...
override PKGDIR = ti/sdo/ce/utils/rtcfg
...
package/%.xdc.inc package/%_ti.sdo.ce.utils.rtcfg.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.ce.utils.rtcfg" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.ce.utils.rtcfg $@
...
.PHONY: release,ti_sdo_ce_utils_rtcfg
ti_sdo_ce_utils_rtcfg.tar: package/package.bld.xml
ti_sdo_ce_utils_rtcfg.tar: package/package.ext.xml
ti_sdo_ce_utils_rtcfg.tar: package/package.rel.dot
ti_sdo_ce_utils_rtcfg.tar: package/build.cfg
ti_sdo_ce_utils_rtcfg.tar: package/package.xdc.inc
ti_sdo_ce_utils_rtcfg.tar: package.bld
ti_sdo_ce_utils_rtcfg.tar: rtcfg.c
ti_sdo_ce_utils_rtcfg.tar: rtcfg_fcinit.c
ti_sdo_ce_utils_rtcfg.tar: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_ce_utils_rtcfg.tar.dep
endif
package/rel/ti_sdo_ce_utils_rtcfg/ti/sdo/ce/utils/rtcfg/package/package.rel.xml:

ti_sdo_ce_utils_rtcfg.tar: package/rel/ti_sdo_ce_utils_rtcfg.xdc.inc package/rel/ti_sdo_ce_utils_rtcfg/ti/sdo/ce/utils/rtcfg/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sdo_ce_utils_rtcfg.xdc.inc,package/rel/ti_sdo_ce_utils_rtcfg.tar.dep)


release release,ti_sdo_ce_utils_rtcfg: all ti_sdo_ce_utils_rtcfg.tar
clean:: .clean
	-$(RM) ti_sdo_ce_utils_rtcfg.tar
	-$(RM) package/rel/ti_sdo_ce_utils_rtcfg.xdc.inc
	-$(RM) package/rel/ti_sdo_ce_utils_rtcfg.tar.dep
