...
override PKGDIR = ti/sdo/ce/utils/trace
...
package/%.xdc.inc package/%_ti.sdo.ce.utils.trace.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.ce.utils.trace" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.ce.utils.trace $@

.libraries,v5T .libraries: lib/release/TraceUtil.av5T

-include lib/release/TraceUtil.av5T.mak
lib/release/TraceUtil.av5T: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/release/TraceUtil/package/package_ti.sdo.ce.utils.trace.ov5T package/lib/lib/release/TraceUtil/TraceUtil.ov5T  into $@ ...
	$(gnu.targets.arm.GCArmv5T.rootDir)/arm-none-linux-gnueabi/bin/ar  cr $@   package/lib/lib/release/TraceUtil/package/package_ti.sdo.ce.utils.trace.ov5T package/lib/lib/release/TraceUtil/TraceUtil.ov5T 
lib/release/TraceUtil.av5T: export LD_LIBRARY_PATH=

clean,v5T clean::
	-$(RM) lib/release/TraceUtil.av5T
.libraries,v5T .libraries: lib/debug/TraceUtil.av5T

-include lib/debug/TraceUtil.av5T.mak
lib/debug/TraceUtil.av5T: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/debug/TraceUtil/package/package_ti.sdo.ce.utils.trace.ov5T package/lib/lib/debug/TraceUtil/TraceUtil.ov5T  into $@ ...
	$(gnu.targets.arm.GCArmv5T.rootDir)/arm-none-linux-gnueabi/bin/ar  cr $@   package/lib/lib/debug/TraceUtil/package/package_ti.sdo.ce.utils.trace.ov5T package/lib/lib/debug/TraceUtil/TraceUtil.ov5T 
lib/debug/TraceUtil.av5T: export LD_LIBRARY_PATH=

clean,v5T clean::
	-$(RM) lib/debug/TraceUtil.av5T
test:;
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
.PHONY: package_ti.sdo.ce.utils.trace.ov5T,copy
package_ti.sdo.ce.utils.trace.ov5T,copy : package_ti.sdo.ce.utils.trace.ov5T,0,copy package_ti.sdo.ce.utils.trace.ov5T,1,copy 
	@

package_ti.sdo.ce.utils.trace.ov5T,0,copy : package/lib/lib/debug/TraceUtil/package/package_ti.sdo.ce.utils.trace.ov5T
package_ti.sdo.ce.utils.trace.ov5T,1,copy : package/lib/lib/release/TraceUtil/package/package_ti.sdo.ce.utils.trace.ov5T
.PHONY: package_ti.sdo.ce.utils.trace.sv5T,copy
package_ti.sdo.ce.utils.trace.sv5T,copy : package_ti.sdo.ce.utils.trace.sv5T,0,copy package_ti.sdo.ce.utils.trace.sv5T,1,copy 
	@

package_ti.sdo.ce.utils.trace.sv5T,0,copy : package/lib/lib/debug/TraceUtil/package/package_ti.sdo.ce.utils.trace.sv5T
package_ti.sdo.ce.utils.trace.sv5T,1,copy : package/lib/lib/release/TraceUtil/package/package_ti.sdo.ce.utils.trace.sv5T
.PHONY: TraceUtil.ov5T,copy
TraceUtil.ov5T,copy : TraceUtil.ov5T,0,copy TraceUtil.ov5T,1,copy 
	@

TraceUtil.ov5T,0,copy : package/lib/lib/debug/TraceUtil/TraceUtil.ov5T
TraceUtil.ov5T,1,copy : package/lib/lib/release/TraceUtil/TraceUtil.ov5T
.PHONY: TraceUtil.sv5T,copy
TraceUtil.sv5T,copy : TraceUtil.sv5T,0,copy TraceUtil.sv5T,1,copy 
	@

TraceUtil.sv5T,0,copy : package/lib/lib/debug/TraceUtil/TraceUtil.sv5T
TraceUtil.sv5T,1,copy : package/lib/lib/release/TraceUtil/TraceUtil.sv5T

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,ti_sdo_ce_utils_trace
ti_sdo_ce_utils_trace.tar: package/package.bld.xml
ti_sdo_ce_utils_trace.tar: package/package.ext.xml
ti_sdo_ce_utils_trace.tar: package/package.rel.dot
ti_sdo_ce_utils_trace.tar: package/build.cfg
ti_sdo_ce_utils_trace.tar: package/package.xdc.inc
ti_sdo_ce_utils_trace.tar: TraceUtil.h
ti_sdo_ce_utils_trace.tar: package.bld
ti_sdo_ce_utils_trace.tar: simple_GCArmv5T.mak
ti_sdo_ce_utils_trace.tar: package/package.cfg.xdc.inc
ti_sdo_ce_utils_trace.tar: lib/release/TraceUtil.av5T
ti_sdo_ce_utils_trace.tar: package/package_ti.sdo.ce.utils.trace.c
ti_sdo_ce_utils_trace.tar: TraceUtil.c
ti_sdo_ce_utils_trace.tar: lib/debug/TraceUtil.av5T
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_ce_utils_trace.tar.dep
endif
package/rel/ti_sdo_ce_utils_trace/ti/sdo/ce/utils/trace/package/package.rel.xml:

ti_sdo_ce_utils_trace.tar: package/rel/ti_sdo_ce_utils_trace.xdc.inc package/rel/ti_sdo_ce_utils_trace/ti/sdo/ce/utils/trace/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sdo_ce_utils_trace.xdc.inc,package/rel/ti_sdo_ce_utils_trace.tar.dep)


release release,ti_sdo_ce_utils_trace: all ti_sdo_ce_utils_trace.tar
clean:: .clean
	-$(RM) ti_sdo_ce_utils_trace.tar
	-$(RM) package/rel/ti_sdo_ce_utils_trace.xdc.inc
	-$(RM) package/rel/ti_sdo_ce_utils_trace.tar.dep
...
ifeq (,$(wildcard package/lib/lib/release/TraceUtil))
    $(shell $(MKDIR) package/lib/lib/release/TraceUtil)
endif
ifeq (,$(wildcard package/lib/lib/release/TraceUtil/package))
    $(shell $(MKDIR) package/lib/lib/release/TraceUtil/package)
endif
ifeq (,$(wildcard package/lib/lib/debug))
    $(shell $(MKDIR) package/lib/lib/debug)
endif
ifeq (,$(wildcard package/lib/lib/debug/TraceUtil))
    $(shell $(MKDIR) package/lib/lib/debug/TraceUtil)
endif
ifeq (,$(wildcard package/lib/lib/debug/TraceUtil/package))
    $(shell $(MKDIR) package/lib/lib/debug/TraceUtil/package)
endif
endif
clean::
	-$(RMDIR) package
