...
override PKGDIR = ti/sdo/ce/utils
...
package/%.xdc.inc package/%_ti.sdo.ce.utils.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.ce.utils" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.ce.utils $@
...
.PHONY: release,ti_sdo_ce_utils
ti_sdo_ce_utils.tar: package/package.bld.xml
ti_sdo_ce_utils.tar: package/package.ext.xml
ti_sdo_ce_utils.tar: package/package.rel.dot
ti_sdo_ce_utils.tar: package/build.cfg
ti_sdo_ce_utils.tar: package/package.xdc.inc
ti_sdo_ce_utils.tar: libvers.xdt
ti_sdo_ce_utils.tar: package.bld
ti_sdo_ce_utils.tar: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_ce_utils.tar.dep
endif
package/rel/ti_sdo_ce_utils/ti/sdo/ce/utils/package/package.rel.xml:

ti_sdo_ce_utils.tar: package/rel/ti_sdo_ce_utils.xdc.inc package/rel/ti_sdo_ce_utils/ti/sdo/ce/utils/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sdo_ce_utils.xdc.inc,package/rel/ti_sdo_ce_utils.tar.dep)


release release,ti_sdo_ce_utils: all ti_sdo_ce_utils.tar
clean:: .clean
	-$(RM) ti_sdo_ce_utils.tar
	-$(RM) package/rel/ti_sdo_ce_utils.xdc.inc
	-$(RM) package/rel/ti_sdo_ce_utils.tar.dep
