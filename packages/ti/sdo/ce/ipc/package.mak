...
package/%.xdc.inc package/%_ti.sdo.ce.ipc.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.ce.ipc" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.ce.ipc $@
...
.PHONY: release,ti_sdo_ce_ipc
ti_sdo_ce_ipc.tar: package/package.bld.xml
ti_sdo_ce_ipc.tar: package/package.ext.xml
ti_sdo_ce_ipc.tar: package/package.rel.dot
ti_sdo_ce_ipc.tar: package/build.cfg
ti_sdo_ce_ipc.tar: package/package.xdc.inc
ti_sdo_ce_ipc.tar: Processor.h
ti_sdo_ce_ipc.tar: Comm.h
ti_sdo_ce_ipc.tar: package.bld
ti_sdo_ce_ipc.tar: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_ce_ipc.tar.dep
endif
package/rel/ti_sdo_ce_ipc/ti/sdo/ce/ipc/package/package.rel.xml:

ti_sdo_ce_ipc.tar: package/rel/ti_sdo_ce_ipc.xdc.inc package/rel/ti_sdo_ce_ipc/ti/sdo/ce/ipc/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sdo_ce_ipc.xdc.inc,package/rel/ti_sdo_ce_ipc.tar.dep)


release release,ti_sdo_ce_ipc: all ti_sdo_ce_ipc.tar
clean:: .clean
	-$(RM) ti_sdo_ce_ipc.tar
	-$(RM) package/rel/ti_sdo_ce_ipc.xdc.inc
	-$(RM) package/rel/ti_sdo_ce_ipc.tar.dep
