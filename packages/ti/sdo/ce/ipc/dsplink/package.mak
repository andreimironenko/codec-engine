...
override PKGDIR = ti/sdo/ce/ipc/dsplink
...
/swcoe/sdk/cm/netra/ti-ezsdk_dm814x-evm_5_05_01_04/component-sources/syslink_2_20_00_14/packages/ti/syslink/package.xs:
package.mak: /swcoe/sdk/cm/netra/ti-ezsdk_dm814x-evm_5_05_01_04/component-sources/syslink_2_20_00_14/packages/ti/syslink/package.xs
endif
...
package/%.xdc.inc package/%_ti.sdo.ce.ipc.dsplink.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.ce.ipc.dsplink" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.ce.ipc.dsplink $@

.libraries,v5T .libraries: lib/debug/ipc_syslink.av5T

-include lib/debug/ipc_syslink.av5T.mak
lib/debug/ipc_syslink.av5T: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/debug/ipc_syslink/package/package_ti.sdo.ce.ipc.dsplink.ov5T package/lib/lib/debug/ipc_syslink/Processor_dsplink.ov5T package/lib/lib/debug/ipc_syslink/Comm_dsplink.ov5T  into $@ ...
	$(gnu.targets.arm.GCArmv5T.rootDir)/arm-none-linux-gnueabi/bin/ar  cr $@   package/lib/lib/debug/ipc_syslink/package/package_ti.sdo.ce.ipc.dsplink.ov5T package/lib/lib/debug/ipc_syslink/Processor_dsplink.ov5T package/lib/lib/debug/ipc_syslink/Comm_dsplink.ov5T 
lib/debug/ipc_syslink.av5T: export LD_LIBRARY_PATH=

clean,v5T clean::
	-$(RM) lib/debug/ipc_syslink.av5T
.libraries,v5T .libraries: lib/release/ipc_syslink.av5T

-include lib/release/ipc_syslink.av5T.mak
lib/release/ipc_syslink.av5T: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/release/ipc_syslink/package/package_ti.sdo.ce.ipc.dsplink.ov5T package/lib/lib/release/ipc_syslink/Processor_dsplink.ov5T package/lib/lib/release/ipc_syslink/Comm_dsplink.ov5T  into $@ ...
	$(gnu.targets.arm.GCArmv5T.rootDir)/arm-none-linux-gnueabi/bin/ar  cr $@   package/lib/lib/release/ipc_syslink/package/package_ti.sdo.ce.ipc.dsplink.ov5T package/lib/lib/release/ipc_syslink/Processor_dsplink.ov5T package/lib/lib/release/ipc_syslink/Comm_dsplink.ov5T 
lib/release/ipc_syslink.av5T: export LD_LIBRARY_PATH=

clean,v5T clean::
	-$(RM) lib/release/ipc_syslink.av5T
test:;
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
.PHONY: package_ti.sdo.ce.ipc.dsplink.ov5T,copy
package_ti.sdo.ce.ipc.dsplink.ov5T,copy : package_ti.sdo.ce.ipc.dsplink.ov5T,0,copy package_ti.sdo.ce.ipc.dsplink.ov5T,1,copy 
	@

package_ti.sdo.ce.ipc.dsplink.ov5T,0,copy : package/lib/lib/debug/ipc_syslink/package/package_ti.sdo.ce.ipc.dsplink.ov5T
package_ti.sdo.ce.ipc.dsplink.ov5T,1,copy : package/lib/lib/release/ipc_syslink/package/package_ti.sdo.ce.ipc.dsplink.ov5T
.PHONY: package_ti.sdo.ce.ipc.dsplink.sv5T,copy
package_ti.sdo.ce.ipc.dsplink.sv5T,copy : package_ti.sdo.ce.ipc.dsplink.sv5T,0,copy package_ti.sdo.ce.ipc.dsplink.sv5T,1,copy 
	@

package_ti.sdo.ce.ipc.dsplink.sv5T,0,copy : package/lib/lib/debug/ipc_syslink/package/package_ti.sdo.ce.ipc.dsplink.sv5T
package_ti.sdo.ce.ipc.dsplink.sv5T,1,copy : package/lib/lib/release/ipc_syslink/package/package_ti.sdo.ce.ipc.dsplink.sv5T
.PHONY: Processor_dsplink.ov5T,copy
Processor_dsplink.ov5T,copy : Processor_dsplink.ov5T,0,copy Processor_dsplink.ov5T,1,copy 
	@

Processor_dsplink.ov5T,0,copy : package/lib/lib/debug/ipc_syslink/Processor_dsplink.ov5T
Processor_dsplink.ov5T,1,copy : package/lib/lib/release/ipc_syslink/Processor_dsplink.ov5T
.PHONY: Processor_dsplink.sv5T,copy
Processor_dsplink.sv5T,copy : Processor_dsplink.sv5T,0,copy Processor_dsplink.sv5T,1,copy 
	@

Processor_dsplink.sv5T,0,copy : package/lib/lib/debug/ipc_syslink/Processor_dsplink.sv5T
Processor_dsplink.sv5T,1,copy : package/lib/lib/release/ipc_syslink/Processor_dsplink.sv5T
.PHONY: Comm_dsplink.ov5T,copy
Comm_dsplink.ov5T,copy : Comm_dsplink.ov5T,0,copy Comm_dsplink.ov5T,1,copy 
	@

Comm_dsplink.ov5T,0,copy : package/lib/lib/debug/ipc_syslink/Comm_dsplink.ov5T
Comm_dsplink.ov5T,1,copy : package/lib/lib/release/ipc_syslink/Comm_dsplink.ov5T
.PHONY: Comm_dsplink.sv5T,copy
Comm_dsplink.sv5T,copy : Comm_dsplink.sv5T,0,copy Comm_dsplink.sv5T,1,copy 
	@

Comm_dsplink.sv5T,0,copy : package/lib/lib/debug/ipc_syslink/Comm_dsplink.sv5T
Comm_dsplink.sv5T,1,copy : package/lib/lib/release/ipc_syslink/Comm_dsplink.sv5T

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,ti_sdo_ce_ipc_dsplink
ti_sdo_ce_ipc_dsplink.tar: package/package.bld.xml
ti_sdo_ce_ipc_dsplink.tar: package/package.ext.xml
ti_sdo_ce_ipc_dsplink.tar: package/package.rel.dot
ti_sdo_ce_ipc_dsplink.tar: package/build.cfg
ti_sdo_ce_ipc_dsplink.tar: package/package.xdc.inc
ti_sdo_ce_ipc_dsplink.tar: package.bld
ti_sdo_ce_ipc_dsplink.tar: _adapted_link_gpptypes.h
ti_sdo_ce_ipc_dsplink.tar: simple_GCArmv5T.mak
ti_sdo_ce_ipc_dsplink.tar: package/package.cfg.xdc.inc
ti_sdo_ce_ipc_dsplink.tar: lib/debug/ipc_syslink.av5T
ti_sdo_ce_ipc_dsplink.tar: package/package_ti.sdo.ce.ipc.dsplink.c
ti_sdo_ce_ipc_dsplink.tar: Processor_dsplink.c
ti_sdo_ce_ipc_dsplink.tar: Comm_dsplink.c
ti_sdo_ce_ipc_dsplink.tar: lib/release/ipc_syslink.av5T
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_ce_ipc_dsplink.tar.dep
endif
package/rel/ti_sdo_ce_ipc_dsplink/ti/sdo/ce/ipc/dsplink/package/package.rel.xml:

ti_sdo_ce_ipc_dsplink.tar: package/rel/ti_sdo_ce_ipc_dsplink.xdc.inc package/rel/ti_sdo_ce_ipc_dsplink/ti/sdo/ce/ipc/dsplink/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sdo_ce_ipc_dsplink.xdc.inc,package/rel/ti_sdo_ce_ipc_dsplink.tar.dep)


release release,ti_sdo_ce_ipc_dsplink: all ti_sdo_ce_ipc_dsplink.tar
clean:: .clean
	-$(RM) ti_sdo_ce_ipc_dsplink.tar
	-$(RM) package/rel/ti_sdo_ce_ipc_dsplink.xdc.inc
	-$(RM) package/rel/ti_sdo_ce_ipc_dsplink.tar.dep
...
ifeq (,$(wildcard package/lib/lib/debug/ipc_syslink))
    $(shell $(MKDIR) package/lib/lib/debug/ipc_syslink)
endif
ifeq (,$(wildcard package/lib/lib/debug/ipc_syslink/package))
    $(shell $(MKDIR) package/lib/lib/debug/ipc_syslink/package)
endif
ifeq (,$(wildcard package/lib/lib/release))
    $(shell $(MKDIR) package/lib/lib/release)
endif
ifeq (,$(wildcard package/lib/lib/release/ipc_syslink))
    $(shell $(MKDIR) package/lib/lib/release/ipc_syslink)
endif
ifeq (,$(wildcard package/lib/lib/release/ipc_syslink/package))
    $(shell $(MKDIR) package/lib/lib/release/ipc_syslink/package)
endif
endif
clean::
	-$(RMDIR) package
