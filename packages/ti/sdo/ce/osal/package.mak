...
override PKGDIR = ti/sdo/ce/osal
...
package/%.xdc.inc package/%_ti.sdo.ce.osal.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.sdo.ce.osal" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.sdo.ce.osal $@
...
lib/debug/osal.aem3: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/debug/osal/package/package_ti.sdo.ce.osal.oem3 package/lib/lib/debug/osal/Queue.oem3  into $@ ...
	$(ti.targets.arm.elf.M3.rootDir)/bin/ar470  rq $@   package/lib/lib/debug/osal/package/package_ti.sdo.ce.osal.oem3 package/lib/lib/debug/osal/Queue.oem3 
...
lib/release/osal.aem3: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/release/osal/package/package_ti.sdo.ce.osal.oem3 package/lib/lib/release/osal/Queue.oem3  into $@ ...
	$(ti.targets.arm.elf.M3.rootDir)/bin/ar470  rq $@   package/lib/lib/release/osal/package/package_ti.sdo.ce.osal.oem3 package/lib/lib/release/osal/Queue.oem3 
...
lib/debug/osal.ae674: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/debug/osal/package/package_ti.sdo.ce.osal.oe674 package/lib/lib/debug/osal/Queue.oe674  into $@ ...
	$(ti.targets.elf.C674.rootDir)/bin/ar6x  rq $@   package/lib/lib/debug/osal/package/package_ti.sdo.ce.osal.oe674 package/lib/lib/debug/osal/Queue.oe674 
...
lib/release/osal.ae674: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/release/osal/package/package_ti.sdo.ce.osal.oe674 package/lib/lib/release/osal/Queue.oe674  into $@ ...
	$(ti.targets.elf.C674.rootDir)/bin/ar6x  rq $@   package/lib/lib/release/osal/package/package_ti.sdo.ce.osal.oe674 package/lib/lib/release/osal/Queue.oe674 
...
.libraries,v5T .libraries: lib/debug/osal.av5T

-include lib/debug/osal.av5T.mak
lib/debug/osal.av5T: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/debug/osal/package/package_ti.sdo.ce.osal.ov5T package/lib/lib/debug/osal/Queue.ov5T  into $@ ...
	$(gnu.targets.arm.GCArmv5T.rootDir)/arm-none-linux-gnueabi/bin/ar  cr $@   package/lib/lib/debug/osal/package/package_ti.sdo.ce.osal.ov5T package/lib/lib/debug/osal/Queue.ov5T 
lib/debug/osal.av5T: export LD_LIBRARY_PATH=

clean,v5T clean::
	-$(RM) lib/debug/osal.av5T
.libraries,v5T .libraries: lib/release/osal.av5T

-include lib/release/osal.av5T.mak
lib/release/osal.av5T: 
	$(RM) $@
	@$(MSG) archiving package/lib/lib/release/osal/package/package_ti.sdo.ce.osal.ov5T package/lib/lib/release/osal/Queue.ov5T  into $@ ...
	$(gnu.targets.arm.GCArmv5T.rootDir)/arm-none-linux-gnueabi/bin/ar  cr $@   package/lib/lib/release/osal/package/package_ti.sdo.ce.osal.ov5T package/lib/lib/release/osal/Queue.ov5T 
lib/release/osal.av5T: export LD_LIBRARY_PATH=

clean,v5T clean::
	-$(RM) lib/release/osal.av5T
test:;
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
.PHONY: package_ti.sdo.ce.osal.oem3,copy
package_ti.sdo.ce.osal.oem3,copy : package_ti.sdo.ce.osal.oem3,0,copy package_ti.sdo.ce.osal.oem3,1,copy 
	@

package_ti.sdo.ce.osal.oem3,0,copy : package/lib/lib/debug/osal/package/package_ti.sdo.ce.osal.oem3
package_ti.sdo.ce.osal.oem3,1,copy : package/lib/lib/release/osal/package/package_ti.sdo.ce.osal.oem3
.PHONY: package_ti.sdo.ce.osal.sem3,copy
package_ti.sdo.ce.osal.sem3,copy : package_ti.sdo.ce.osal.sem3,0,copy package_ti.sdo.ce.osal.sem3,1,copy 
	@

package_ti.sdo.ce.osal.sem3,0,copy : package/lib/lib/debug/osal/package/package_ti.sdo.ce.osal.sem3
package_ti.sdo.ce.osal.sem3,1,copy : package/lib/lib/release/osal/package/package_ti.sdo.ce.osal.sem3
.PHONY: Queue.oem3,copy
Queue.oem3,copy : Queue.oem3,0,copy Queue.oem3,1,copy 
	@

Queue.oem3,0,copy : package/lib/lib/debug/osal/Queue.oem3
Queue.oem3,1,copy : package/lib/lib/release/osal/Queue.oem3
.PHONY: Queue.sem3,copy
Queue.sem3,copy : Queue.sem3,0,copy Queue.sem3,1,copy 
	@

Queue.sem3,0,copy : package/lib/lib/debug/osal/Queue.sem3
Queue.sem3,1,copy : package/lib/lib/release/osal/Queue.sem3
.PHONY: package_ti.sdo.ce.osal.oe674,copy
package_ti.sdo.ce.osal.oe674,copy : package_ti.sdo.ce.osal.oe674,0,copy package_ti.sdo.ce.osal.oe674,1,copy 
	@

package_ti.sdo.ce.osal.oe674,0,copy : package/lib/lib/debug/osal/package/package_ti.sdo.ce.osal.oe674
package_ti.sdo.ce.osal.oe674,1,copy : package/lib/lib/release/osal/package/package_ti.sdo.ce.osal.oe674
.PHONY: package_ti.sdo.ce.osal.se674,copy
package_ti.sdo.ce.osal.se674,copy : package_ti.sdo.ce.osal.se674,0,copy package_ti.sdo.ce.osal.se674,1,copy 
	@

package_ti.sdo.ce.osal.se674,0,copy : package/lib/lib/debug/osal/package/package_ti.sdo.ce.osal.se674
package_ti.sdo.ce.osal.se674,1,copy : package/lib/lib/release/osal/package/package_ti.sdo.ce.osal.se674
.PHONY: Queue.oe674,copy
Queue.oe674,copy : Queue.oe674,0,copy Queue.oe674,1,copy 
	@

Queue.oe674,0,copy : package/lib/lib/debug/osal/Queue.oe674
Queue.oe674,1,copy : package/lib/lib/release/osal/Queue.oe674
.PHONY: Queue.se674,copy
Queue.se674,copy : Queue.se674,0,copy Queue.se674,1,copy 
	@

Queue.se674,0,copy : package/lib/lib/debug/osal/Queue.se674
Queue.se674,1,copy : package/lib/lib/release/osal/Queue.se674
.PHONY: package_ti.sdo.ce.osal.ov5T,copy
package_ti.sdo.ce.osal.ov5T,copy : package_ti.sdo.ce.osal.ov5T,0,copy package_ti.sdo.ce.osal.ov5T,1,copy 
	@

package_ti.sdo.ce.osal.ov5T,0,copy : package/lib/lib/debug/osal/package/package_ti.sdo.ce.osal.ov5T
package_ti.sdo.ce.osal.ov5T,1,copy : package/lib/lib/release/osal/package/package_ti.sdo.ce.osal.ov5T
.PHONY: package_ti.sdo.ce.osal.sv5T,copy
package_ti.sdo.ce.osal.sv5T,copy : package_ti.sdo.ce.osal.sv5T,0,copy package_ti.sdo.ce.osal.sv5T,1,copy 
	@

package_ti.sdo.ce.osal.sv5T,0,copy : package/lib/lib/debug/osal/package/package_ti.sdo.ce.osal.sv5T
package_ti.sdo.ce.osal.sv5T,1,copy : package/lib/lib/release/osal/package/package_ti.sdo.ce.osal.sv5T
.PHONY: Queue.ov5T,copy
Queue.ov5T,copy : Queue.ov5T,0,copy Queue.ov5T,1,copy 
	@

Queue.ov5T,0,copy : package/lib/lib/debug/osal/Queue.ov5T
Queue.ov5T,1,copy : package/lib/lib/release/osal/Queue.ov5T
.PHONY: Queue.sv5T,copy
Queue.sv5T,copy : Queue.sv5T,0,copy Queue.sv5T,1,copy 
	@

Queue.sv5T,0,copy : package/lib/lib/debug/osal/Queue.sv5T
Queue.sv5T,1,copy : package/lib/lib/release/osal/Queue.sv5T

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,ti_sdo_ce_osal
ti_sdo_ce_osal.tar: package/package.bld.xml
ti_sdo_ce_osal.tar: package/package.ext.xml
ti_sdo_ce_osal.tar: package/package.rel.dot
ti_sdo_ce_osal.tar: package/build.cfg
ti_sdo_ce_osal.tar: package/package.xdc.inc
ti_sdo_ce_osal.tar: File.h
ti_sdo_ce_osal.tar: Global.h
ti_sdo_ce_osal.tar: Queue.h
ti_sdo_ce_osal.tar: Memory.h
ti_sdo_ce_osal.tar: Loader.h
ti_sdo_ce_osal.tar: Lock.h
ti_sdo_ce_osal.tar: LockMP.h
ti_sdo_ce_osal.tar: SemMP.h
ti_sdo_ce_osal.tar: Trace.h
ti_sdo_ce_osal.tar: package.bld
ti_sdo_ce_osal.tar: simple_GCArmv5T.mak
ti_sdo_ce_osal.tar: package/package.cfg.xdc.inc
ti_sdo_ce_osal.tar: lib/debug/osal.aem3
ti_sdo_ce_osal.tar: package/package_ti.sdo.ce.osal.c
ti_sdo_ce_osal.tar: Queue.c
ti_sdo_ce_osal.tar: lib/release/osal.aem3
ti_sdo_ce_osal.tar: lib/debug/osal.ae674
ti_sdo_ce_osal.tar: lib/release/osal.ae674
ti_sdo_ce_osal.tar: lib/debug/osal.av5T
ti_sdo_ce_osal.tar: lib/release/osal.av5T
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_sdo_ce_osal.tar.dep
endif
package/rel/ti_sdo_ce_osal/ti/sdo/ce/osal/package/package.rel.xml:

ti_sdo_ce_osal.tar: package/rel/ti_sdo_ce_osal.xdc.inc package/rel/ti_sdo_ce_osal/ti/sdo/ce/osal/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_sdo_ce_osal.xdc.inc,package/rel/ti_sdo_ce_osal.tar.dep)


release release,ti_sdo_ce_osal: all ti_sdo_ce_osal.tar
clean:: .clean
	-$(RM) ti_sdo_ce_osal.tar
	-$(RM) package/rel/ti_sdo_ce_osal.xdc.inc
	-$(RM) package/rel/ti_sdo_ce_osal.tar.dep
